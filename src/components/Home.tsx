      ...
      <main className="pt-20 pb-16">
        ...
        <section className="container mx-auto px-4 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              <h3 className="text-xl font-semibold text-gray-800">Search for Books</h3>
              <p className="text-gray-600 mt-2">Learn how to search for books in our digital library and access them online.</p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              <h3 className="text-xl font-semibold text-gray-800">Reserve a Book</h3>
              <p className="text-gray-600 mt-2">Learn how to reserve books online and pick them up at your convenience.</p>
            </div>
          </div>
        </section>
      </main>
